...
export default function 标签工作台(props: 标签工作台Props) {
  ...
  return (
    <div className={styles.root}>
      <div className={styles.combinedTopSection}>
        <div className={styles.topBlock}>
          <h3 className={styles.blockTitle}>搜索标签</h3>
      ...
      <div className={styles.section}>
        <div className={styles.sectionHeader}>
          <h3 className={styles.sectionTitle}>标签选择</h3>
          <p className={styles.noteText}>这里统一完成选择、新增和编辑标签。</p>
        </div>
        ...
        {props.标签种类列表.map((标签种类) => {
          ...
          return (
            <div key={`kind-${标签种类.id}`} className={styles.kindSection}>
              ...
              {标签种类.是否树形 ? (
                <TagSelectionTree
                  ...
                  渲染节点下方内容={(标签) => {
                    ...
                    if (显示编辑表单) {
                      return (
                        <div className={styles.inlineFormHost}>{渲染编辑表单()}</div>
                      );
                    }
