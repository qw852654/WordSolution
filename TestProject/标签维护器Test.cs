...
namespace TestProject
{
    ...
    public class 标签维护器Test
    {
        ...
        public void AddTag_创建题型根与子标签_文件保留()
        {
            ...
            var rootId = maint.新增标签(tagName: "题型", parentId: null, category: "题型");

            // 添加子标签（不弹窗，因为父存在）
            var childId = maint.新增标签(tagName: "填空题", parentId: rootId, category: "题型");
        ...
        public void AddTag_难度叶子带数值_文件保留()
        {
            ...
            var diffRootId = maint.新增标签(tagName: "难度", parentId: null, category: "难度");

            var s1 = maint.新增标签(tagName: "一星", parentId: diffRootId, category: "难度", numericValue: 1);
            var s3 = maint.新增标签(tagName: "三星", parentId: diffRootId, category: "难度", numericValue: 3);
        ...
        public void Reload_再次加载结构一致_文件保留()
        {
            ...
            var rootId = maint.新增标签(tagName: "知识点", parentId: null, category: "知识点");
            var childId = maint.新增标签(tagName: "数学", parentId: rootId, category: "知识点");
