const en = {
  ...
  sectionPage: {
    ...
    questionImport: {
      ...
      description:
        'Upload a Word document with multiple questions. Candidates stay in a temporary session first. Current Section: ',
      target: {
        sectionTopLevel:
          'Import target: current Section top level. A later page action can insert confirmed ContentBlock as a top-level SectionItem.',
        atomicSectionPanel:
          'Import target: {sectionTitle} / {atomicSectionTitle} / {panelTitle}. A later page action can insert confirmed ContentBlock into this AtomicSectionPanel.',
      },
      fileLabel: 'Choose .docx file',
      uploadAction: 'Upload and split',
      cancelAction: 'Cancel',
      ...
      metadataTitle: 'Confirm import metadata',
      titleLabel: 'Name',
      ...
      confirmAction: 'Confirm as ContentBlock',
      cancelSessionAction: 'Cancel import session',
      missingSection: 'No available Section, so multi-question Word import cannot start.',
      missingSession: 'No active import session. Upload the Word document again.',
      uploading: 'Uploading and splitting Word...',
      uploaded: '{count} candidates generated. Select one and confirm import.',
      uploadFailed: 'Failed to upload multi-question Word.',
      confirming: 'Confirming candidate import...',
      confirmed: 'Imported ContentBlock #{contentBlockId}.',
      confirmFailed: 'Failed to confirm candidate import.',
