const en = {
  ...
  components: {
    ...
    teachingTopicTree: {
      title: 'TeachingTopicTree',
      description: 'Structure tree for locating teaching topics.',
    ...
    teachingTopicTreeContextMenu: {
      label: 'TeachingTopicTree context menu',
      target: 'Context target',
      actions: {
  ...
  lab: {
    ...
    sections: {
      ...
      teachingTopicTree: {
        title: 'TeachingTopicTree',
        description:
          'Validate topic hierarchy, expand/collapse, selected state, long titles, archived disabled nodes, and shared BasicTree behavior.',
        ...
        feedbackTitle: 'Mock feedback',
        emptyFeedback: 'No TeachingTopicTree menu action has been triggered yet.',
