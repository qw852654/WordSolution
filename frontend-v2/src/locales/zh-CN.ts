const zhCN = {
  ...
  sectionPage: {
    ...
    questionImport: {
      ...
      eyebrow: 'Section 级导入',
      title: '导入多题 Word',
      description: '上传一个包含多道题目的 Word 文档，候选题会先进入临时会话，当前 Section：',
      target: {
        sectionTopLevel: '导入目标：当前 Section 顶层。后续确认导入后可由页面插入为顶层 SectionItem。',
        atomicSectionPanel:
          '导入目标：{sectionTitle} / {atomicSectionTitle} / {panelTitle}。后续确认导入后可由页面插入为该 AtomicSectionPanel 内部 ContentBlock。',
      },
      fileLabel: '选择 .docx 文件',
      uploadAction: '上传并切割',
      cancelAction: '取消',
      ...
      confirmAction: '确认导入为 ContentBlock',
      cancelSessionAction: '取消导入会话',
      missingSection: '当前没有可用 Section，无法导入多题 Word。',
      missingSession: '当前没有有效导入会话，请重新上传 Word。',
      uploading: '正在上传并切割 Word...',
      uploaded: '已生成 {count} 个候选题，请选择候选并确认导入。',
      uploadFailed: '多题 Word 上传失败。',
      confirming: '正在确认导入候选题...',
      confirmed: '已确认导入 ContentBlock #{contentBlockId}。',
      confirmFailed: '候选题确认导入失败。',
