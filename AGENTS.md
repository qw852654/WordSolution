...
允许 Codex 在执行当前任务时顺手检查相邻代码、组件边界、数据链路和潜在问题。

禁止 Codex 在未经用户确认的情况下顺手修改当前任务范围之外的内容。

如果 Codex 在检查过程中发现可优化、可修复或可顺手整理的事项，必须先向用户说明：
...
Codex 在本仓库中生成 Git commit message 时必须使用中文。

要求：

- 提交标题使用简短中文动宾结构，说明本次提交做了什么。
- 如需生成提交正文，正文也必须使用中文。
- 提交正文优先列出关键改动、验证结果和影响范围。
- 不要默认生成英文提交说明，除非用户明确要求使用英文。
